...
function autoCorrectMessage(messageText){
    ...
    return new Promise(function(resolve, reject) {
        ...
        for(var j=0;j<words.length;j++){
            ...
            unprocessed++;
            dict.spellSuggest(currentWord ,function(err, correct, suggestion, origWord){
                // console.log("********");
                ...
                return new Promise (function (resolve, reject){
                    ...
                    if(correct === false){
                        ...
                        calculatedWord =  suggestion;
                    }
                    else {
                        calculatedWord =  origWord;
                    }
                    ...
                    for(var k=0;k<words.length;k++){
                        ...
                        if(origWord === words[k]){
                            ...
                            {
                                returned[k] = true;
                                returnedWords[k] = calculatedWord;
                            }

                        }
                        if(k === (words.length-1))
                        {
                            var finalMessageString = "";
                            for (var q=0; q<returnedWords.length;q++)
                            {
                                finalMessageString =  finalMessageString +  returnedWords[q] + " ";
                            }
                            resolve(finalMessageString);
                        }
                    }
